...
class LLM:
        ...
        *,
        ...
        Args:
            ...
            priority: The priority of the requests, if any.
                ...
                at the same index.
            cook_flag: 0 for online request, 1 for offline request.
    ...
    def _validate_and_add_requests(
        ...
        *,
        ...
        if cook_flag is not None and len(cook_flag) != num_requests:
            raise ValueError(
                "The lengths of prompts "
                f"({num_requests}) and cook_flag ({len(cook_flag)}) "
                "must be the same."
            )
        ...
        try:
            for i, prompt in enumerate(it):
                ...
                request_id = self._add_request(
                    ...
                    cook_flag=cook_flag[i] if cook_flag else 0,
                )
