...
class SingleTypeKVCacheManager(ABC):
    ...
    def allocate_new_blocks(
        self, request_id: str, num_tokens: int, cook_flag: int = 0
    ) -> list[KVCacheBlock]:
        """
        ...
        if num_new_blocks <= 0:
            ...
            new_blocks = self.block_pool.get_new_blocks(num_new_blocks, cook_flag)
            # print(f"[single_type L144]: allocate {num_new_blocks} new blocks, request_id: {request_id}, offline: {cook_flag}, block_ids: ", end=" ")
            # for block in new_blocks:
            #     print(block.block_id, end=",")
            # print("="*10)
