...
class EngineArgs:
    ...
    enable_hybrid_free_queue: bool = False
    ...
    enable_cook: bool = SchedulerConfig.enable_cook
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        cache_group.add_argument(
            "--enable-hybrid-free-queue",
            **{
                **cache_kwargs["enable_hybrid_free_queue"],
                "default": None,
            },
        )
        cache_group.add_argument(
        ...
        scheduler_group.add_argument(
            "--enable-cook", **scheduler_kwargs["enable_cook"]
        )
