...
from vllm.v1.core.sched.cook_scheduler import CookScheduler
...
def create_scheduler(
    ...
    if not vllm_config.scheduler_config.enable_cook:
        print("[COOK] Using Default Scheduler")
        ...
        print("[COOK] Using CookScheduler")
        
        return CookScheduler(
            vllm_config=vllm_config,
            kv_cache_config=kv_cache_config,
            log_stats=True,
            structured_output_manager=StructuredOutputManager(vllm_config),
