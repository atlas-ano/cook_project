...
class KVCacheManager:
    def __init__(
        ...
        enable_hybrid_free_queue: bool = True,
        ...
        self.coordinator = get_kv_cache_coordinator(
            ...
            enable_hybrid_free_queue=self.enable_hybrid_free_queue,
    ...
    def allocate_slots(
        ...
        if self.enable_caching:
            self.block_pool.touch(request.cook_flag, new_computed_block_list)
        else:
        ...
        new_blocks = self.coordinator.allocate_new_blocks(
            request.request_id, num_tokens_need_slot, num_encoder_tokens, request.cook_flag
        )
